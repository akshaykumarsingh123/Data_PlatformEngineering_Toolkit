...
--  This script does NOT work on Azure SQL Database – you need to replace sys.dm_os_wait_stats with sys.dm_db_wait_stats
--  For a script to use on Azure go here https://sqlperformance.com/2016/03/sql-performance/tuning-azure-sql-database
